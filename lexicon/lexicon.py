...
LEXICON_btn_entering_code: dict[str, str] = {
    "Скачать приложение Mindspa": "http://onelink.to/mindspa",
    "Выбери модель своего телефона": "choose_phone_model",
}
...
LEXICON_btn_no_my_question: dict[str, str] = {
    "Написать администратору": "write_to_administrator",
    "Назад ко всем вопросам": "main_list_questions",
}
...
LEXICON_RU: dict[str, str] = {
    ...
    ,
    '/instruction_entering_code': 'Если у тебя еще нет приложения Mindspa — скачай его и самостоятельно зарегистрируйся.\n\n'
                                  'Выбери модель своего телефона📞.\n'
    ,
    '/instruction_entering_accaunt': '<b>Не могу войти в аккаунт.</b>\n\n'
                                  'Попробуй восстановить доступ через кнопку «Забыли пароль».\n\n'
    ...
    '/no_my_question': '<b>Моего вопроса нет в списке.</b>\n\n'
                                     'Если тебе не удалось найти ответ на свой вопрос, напиши об этом.\n\n'
