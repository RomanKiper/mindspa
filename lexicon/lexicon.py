...
LEXICON_ADMIN: dict[str, str] = {
    ...
    '/instruction_description': '<b>Инструкция для админа.</b>\n'
                                ...
                                '✅<b>Назад</b> - команда, позволяющая позьзователю вернуться назад на один шаг,'
                                ' когда он заполняет форму для отправки админу.\n'
                                '✅<b>admin, administrator, админ, администратор</b> - команды вызова административной панели.\n'
